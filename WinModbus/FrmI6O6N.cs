...
public partial class FrmI6O6N : Form
{
    ...
    {
        var pk = await _modbus.ReadAsync(FunctionCodes.ReadRegister, _host, 0x1000, 14);
    ...
    private async void btnOpenAll_Click(Object sender, EventArgs e)
    {
        //for (var i = 0; i < 4; i++)
        //{
        //    _modbus.WriteCoilAsync(_host, (UInt16)i, 0xFF00);
        //}
    ...
    private async void btnCloseAll_Click(Object sender, EventArgs e)
    {
        //for (var i = 0; i < 4; i++)
        //{
        //    _modbus.WriteCoilAsync(_host, (UInt16)i, 0);
        //}
    ...
    private async void btnWriteAddr_Click(Object sender, EventArgs e)
    {
        ...
        await _modbus.WriteRegistersAsync(_host, 0, new[] { addr });
    }

    private async void btnReadIn_Click(Object sender, EventArgs e)
    {
        await _modbus.ReadDiscreteAsync(_host, 0x0100, 8);
    }
}